...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    ...
    L.marker([ -25.4505655, -49.2324812], {icon: L.icon({
      ...
      iconSize: [40, 40],
      iconAnchor: [20, 40]
    })}).bindPopup("<h3>Campus Politécnico</h3><p>Local do Evento <a href='https://www.openstreetmap.org/node/11142398666' target='_blank' rel='noopener noreferrer'>Open location on osm.org</a>.</p><p>Mapa detalhado:<a href='https://sotm-br.github.io/2023/venue/map' target='_blank' rel='noopener noreferrer'>aqui!</a>.</p>").addTo(map);
